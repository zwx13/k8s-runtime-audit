...
alertOut == 
    crossTenantAlerts 
    \cup danglingRoleBindingsAlerts 
    \cup danglingClusterRoleBindingsAlerts 
    \cup clusterRoleBindingForTenantAlerts 
    \cup roleBindingToClusterTenantAlerts
...
SerializeAtEnd ==
  ...
  /\ IF alertOut # {} THEN
        /\ PrintT("alertOut = " \o ToString(alertOut))
        /\ NatsPublishAlert(alertOut)
        /\ PrintT("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
